...
The official Grupo Terrat website built in [Next.js](https://nextjs.org/) and [Typescript](https://www.typescriptlang.org/) with [TailwindCSS](https://tailwindcss.com/) for styling and [Framer Motion](https://www.framer.com/motion/) animations.
...
```
$ git clone https://github.com/saufth/terrat.git/
```
...
Copyright © 2022 Grupo Terrat. All rights reserved.
