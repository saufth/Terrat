              ...
              <div className='flex items-center gap-x-5'>
                ...
                <div className='block lg:hidden'>
                  <div className='block lg:hidden w-7 h-3 relative [&>span]:transition-all [&>span]:duration-300' onClick={toggleMenu}>
                    <span className={cn('w-full h-[3.5px] bg-accent absolute top-0 right-0', isMenuOpen && 'inset-0 m-auto rotate-45')} />
                    <span className={cn('w-full h-[3.5px] bg-accent absolute bottom-0 right-0', isMenuOpen && 'inset-0 m-auto -rotate-45')} />
